...
namespace Soofle.Application.Services.Vk;
...
public class VkManager : IVkManager
{
    ...
    public async Task SetAsync(Guid userId, string username, string password)
    {
    ...
    private async Task<Soofle.Domain.Proxies.Entities.Proxy> GetProxyAsync(User user)
    {
